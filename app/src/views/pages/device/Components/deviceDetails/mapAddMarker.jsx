...
class MapBox extends Component {
  ...
  componentDidMount() {
    if ("geolocation" in navigator) {
      ...
      navigator
        .geolocation
        .getCurrentPosition(this._showPosition, this._showError);
    } else {
  ...
  render() {
    return (
      <ul className="list-group">
        <li className="list-group-item"><CityPicker source={cityData} noDistrict onOptionChange={this.handleChange}/></li>
        ...
        <li className="list-group-item">
          <ReactQMap ref={instance => {
            ...
            zoomControl: true,
            mapTypeControl: true
          }} apiKey="5MDBZ-ZTW3V-42NPE-UYNBQ-XYEBE-CQBBJ" style={{
            height: 500,
