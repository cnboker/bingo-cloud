                ...
                <CCardBody>
                  <CForm onSubmit={handleSubmit(onSumit)}>
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <CFormInput placeholder="Username" autoComplete="username" {...register('userName', { required: true })} /> {errors.userName && <ValidatorSpan message="required" />}
                    </CInputGroup>
                    <CInputGroup className="mb-4">
                      <CInputGroupText>
                        <CIcon icon={cilLockLocked} />
                      </CInputGroupText>
                      <CFormInput type="password" placeholder="Password" autoComplete="current-password" {...register('password', { required: true })} />
