...
import { CCard, CCardBody, CCardHeader, CCol, CRow, CAccordion, CAccordionBody, CAccordionButton, CAccordionCollapse, CAccordionHeader, CAccordionItem } from '@coreui/react'
          ...
          <CCardBody>
            ...
            <DocsExample href="components/accordion#flush">
              <CAccordion flush>
                <CAccordionItem>
                  <CAccordionHeader>
                    <CAccordionButton collapsed={activeKey2 !== 1} onClick={() => (activeKey2 === 1 ? setActiveKey2(0) : setActiveKey2(1))}>
                      Accordion Item #1
                    </CAccordionButton>
                  </CAccordionHeader>
                ...
                <CAccordionItem>
                  <CAccordionHeader>
                    <CAccordionButton collapsed={activeKey2 !== 2} onClick={() => (activeKey2 === 2 ? setActiveKey2(0) : setActiveKey2(2))}>
                      Accordion Item #2
                    </CAccordionButton>
                  </CAccordionHeader>
                ...
                <CAccordionItem>
                  <CAccordionHeader>
                    <CAccordionButton collapsed={activeKey2 !== 3} onClick={() => (activeKey2 === 3 ? setActiveKey2(0) : setActiveKey2(3))}>
                      Accordion Item #3
                    </CAccordionButton>
                  </CAccordionHeader>
