...
namespace Member.Repositories
{
    ...
    public class MailRepository : RepositoryBase
    {
        ...
        public void Send(string fromMail, string title, string templateId, string p1 = "", string p2 = "", string p3 = "", string p4 = "")
        {
          ...
          (EmailAddress,title, createDateTime,Status,tryCount,TemplateId,Parameter1,Parameter2,Parameter3,Parameter4)
          values (@EmailAddress,@title,getdate(),0,0,@TemplateId,@Parameter1,@Parameter2,@Parameter3,@Parameter4)
          ";
