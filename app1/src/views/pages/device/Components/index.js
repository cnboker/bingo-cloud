...
export default class Index extends Component {
  ...
  componentDidUpdate(preProps, nextState) {
    if (preProps.deviceList !== this.props.deviceList) {
      ...
      if (!this.mqttSubscribled) {
        ...
        this.props.deviceMQTTSubscrible(
          preProps.deviceList.map((x) => x.deviceId)
        );
      }
      ...
      this.props.updateLicense(
        ...
        this.props.authorize.payload.deviceId
      );
    }
  }
  ...
  updateSensor(deviceId) {
    var fanModel = this.props.sensorConfig.fanModel.find(
  ...
  getTableData(page = 0) {
    ...
    if(this.keyword){
      ...
      deviceList = deviceList.filter((item) => {
        ...
        return (item.sensorNo && (item.sensorNo).indexOf(this.keyword) >=0) || (sensorId).indexOf(this.keyword) >=0
      });
    }
        ...
        <div className="row">
          <div className="col-md-3">
            ...
            <button
              ...
              onClick={this.createVM.bind(this)}
            >
              {resources.createVMDevice}
            </button>
            
          </div>
          <div className="col-md-3"><Search onKeywordChange={this.keywordFilter.bind(this)} /></div>
